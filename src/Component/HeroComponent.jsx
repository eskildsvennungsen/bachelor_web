          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-8xl">
                Fremtidens pakketeknologi
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Vi i HOLDT har fått i bachelor-oppgave av <span className="underline decoration-red-500 decoration-2 bg-red-50 hover:bg-red-100"><a href="https://www.tronrud.no/en/">Tronrud</a></span> og legge frem
                en løsning for å detektere hull og lekasjer i snacks poser.
              </p>
